...
/**
 * Parsing AllPrice.json
 *
 * @author Cedrick LUNVEN (@clunven)
 */
public class MtgJsonAllPricesParser implements JsonStreamingParser<CardPrice> {
    
    /** {@inheritDoc} */
    public void parse(InputStream is, Consumer<CardPrice> cardProcessor) 
    throws Exception {
